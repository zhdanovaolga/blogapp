...
use App\Http\Controllers\Frontend\FavoritePostsController;
use Illuminate\Support\Facades\Route;

Route::name("frontend.")->group(function() {
    Route::get("/", [HomeController::class, "index"])->name("home");
    Route::get("/favoritePosts", [FavoritePostsController::class, "index"])->name("favoritePosts");
    ...
    Route::post("/users/subscribe", [UserController::class, "subscribe"])->name("subscribe");
    Route::post("/users/unsubscribe", [UserController::class, "unsubscribe"])->name("unsubscribe");
