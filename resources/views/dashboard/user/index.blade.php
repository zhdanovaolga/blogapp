                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                            <span class="badge bg-{{ $user->status ? "submited" : "unsubmited" }}">

                                            <?php if($isSubscribed == true): ?>
                                            <form action="{{ route("frontend.subscribe", $user->id) }}" method="POST">
                                                        @method("POST")
                                                        @csrf
                                            ...
                                            <?php else: ?>
                                                <form action="{{ route("frontend.unsubscribe", $user->id) }}" method="POST">
                                                        @method("POST")
                                                        @csrf
